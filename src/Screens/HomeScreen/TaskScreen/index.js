...
export default function TaskScreen({ navigation }) {
    ...
    return (
        <Layout style={{ flex: 1 }}>
            <Layout level={'4'} style={{ height: '16%', borderRadius: 20, marginHorizontal: 10, marginVertical: '2%' }}>
                <View>
            ...
            <Button onPress={() => navigation.navigate('TugasBaru')} appearance='filled' style={{ margin: 10 }}>Buat Tugas Baru</Button>
        </Layout>
    )
}